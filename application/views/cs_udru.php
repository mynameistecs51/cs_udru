...
<div class="row col-md-8" style="padding-left:3px;">		
	...
	foreach ($teacher_news as $key_news => $value_news) {
		echo form_hidden('news_id',$value_news->news_id);
		echo "<div class='panel panel-primary ' >";		
			...
			echo substr($value_news ->news_container,0,20)."...<span class='label label-info'>".anchor('ctl_main/page_news','อ่านต่อ')."</span>";  ///// เนื้อหาข่าว  ///////////
